...
export default class Level1 extends Phaser.Scene {
  ...
  create() {
    ...
    // Show text for star
    const starText = this.add.text(2000, 300, "YOU GOT THIS... AH", {
      fontSize: "200px",
      fontStyle: "Bold",
      align: "center",
    });
    ...
    fakeTraps.add(this.physics.add.sprite(150, 400, "apple").setScale(0.2));
    fakeTraps.add(this.physics.add.sprite(250, 300, "apple").setScale(0.2));
    fakeTraps.add(this.physics.add.sprite(430, 400, "apple").setScale(0.2));
    fakeTraps.add(this.physics.add.sprite(1050, 500, "apple").setScale(0.2));
    fakeTraps.add(this.physics.add.sprite(1080, 500, "apple").setScale(0.2));
    ...
    // Trap 1
    const trap1 = this.physics.add.sprite(210, 400, "apple").setScale(0.2);
    ...
    // Trap 2
    const trap2 = this.physics.add.sprite(400, 400, "apple").setScale(0.2);
    ...
    // Trap 3
    const trap3 = this.physics.add.sprite(450, 580, "apple").setScale(0.2);
    ...
    //Trap 4
    const trap4 = this.physics.add.sprite(320, 200, "apple").setScale(0.2);
    ...
    this.physics.add.overlap(this.player, star, () => {
      this.hasStar = true;
      this.sound.play("starMusic", { rate: 1.1 });
    ...
    // Setup camera
    this.cameras.main.setBounds(0, 0, 13000, this.cameras.main.height);
  ...
  update() {
    if (!this.finished && this.player.x > 13500) {
      this.finished = true;
